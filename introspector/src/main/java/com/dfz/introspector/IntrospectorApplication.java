...
//                    propertyDescriptor.setPropertyEditorClass(CarPropertyEditor.class);
                    ...
                    // 方式2
//                    PropertyEditor propertyEditor = propertyDescriptor.createPropertyEditor(CarPropertyEditor.class);
...
//                    System.out.println(person);
        ...
        BeanInfo beanInfo2 = Introspector.getBeanInfo(Person.class);
        Person person = new Person();
        PropertyDescriptor car = new PropertyDescriptor("car", person.getClass());
//        car.getWriteMethod().invoke(car,)
...
//        System.out.println("---------");
//
//        BeanInfo personServiceBeanInfo = Introspector.getBeanInfo(PersonService.class);
//        PropertyDescriptor[] descriptors = beanInfo.getPropertyDescriptors();
//        Arrays.stream(descriptors).forEach(descriptor -> {
//            String name = descriptor.getName();
//        });
//
//        MethodDescriptor[] mDescriptors = personServiceBeanInfo.getMethodDescriptors();
//        Arrays.asList(mDescriptors).forEach(methodDescriptor -> {
//            System.out.println(methodDescriptor.getMethod().getName());
//            if (methodDescriptor.getParameterDescriptors() == null) {
//                System.out.println("parameterDescriptors is empty");
//            } else {
